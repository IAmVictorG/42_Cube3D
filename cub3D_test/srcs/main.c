...
int main(int argc, char const *argv[])
{
    ...
    general->scene->map3D.matrix = general->scene->map.matrix;
    general->scene->map3D.height_map = general->sprites->wall_east->sprite_w * general->scene->map.height_map;
    general->scene->map3D.width_map = general->sprites->wall_east->sprite_h * general->scene->map.width_map;
    general->scene->map3D.size_wall = general->sprites->wall_east->sprite_w;


    //printf("real size wall = %d\n", general->sprites->wall_east->sprite_w);


    printMap(scene->map3D);
