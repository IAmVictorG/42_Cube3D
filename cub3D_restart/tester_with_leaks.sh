...
echo "---------------------------------------------"
leaks -atExit -- ./cub3D maps/errors_map/Invalid11.cub

echo "---------------------------------------------"
leaks -atExit -- ./cub3D maps/errors_map/Invalid12.cub

echo "---------------------------------------------"
leaks -atExit -- ./cub3D maps/errors_map/Invalid13.cub

echo "---------------------------------------------"
leaks -atExit -- ./cub3D maps/errors_map/Invalid14.cub

echo "---------------------------------------------"
leaks -atExit -- ./cub3D maps/errors_map/Invalid15.cub

echo "---------------------------------------------"
leaks -atExit -- ./cub3D maps/errors_map/Invalid16.cub
...
leaks -atExit -- ./cub3D maps/errors_init/Invalid0.cub

echo "---------------------------------------------"
leaks -atExit -- ./cub3D maps/errors_init/Invalid1.cub

echo "---------------------------------------------"
leaks -atExit -- ./cub3D maps/errors_init/Invalid2.cub

echo "---------------------------------------------"
leaks -atExit -- ./cub3D maps/errors_init/Invalid3.cub

echo "---------------------------------------------"
leaks -atExit -- ./cub3D maps/errors_init/Invalid4.cub

echo "---------------------------------------------"
leaks -atExit -- ./cub3D maps/errors_init/Invalid5.cub

echo "---------------------------------------------"
leaks -atExit -- ./cub3D maps/errors_init/Invalid6.cub

echo "---------------------------------------------"
leaks -atExit -- ./cub3D maps/errors_init/Invalid7.cub

echo "---------------------------------------------"
leaks -atExit -- ./cub3D maps/errors_init/Invalid8.cub

echo "---------------------------------------------"
leaks -atExit -- ./cub3D maps/errors_init/Invalid9.cub
...
echo "---------------------------------------------"
leaks -atExit -- ./cub3D maps/errors_init/Invalid21.cub
