...
SRCS =  $(addprefix srcs/, main.c display.c render.c init_window.c) \
		...
		$(addprefix srcs/render3D/, ray_caster.c get_color.c 3D_wall_render.c get_color_near.c 3D_wall_render_near.c find_pixel_screen.c draw_manager.c draw_manager_utils.c draw_manager_utils_near.c pix_in.c) 
